...
//				FMLNetworkHandler.openGui(player,AdventureBackpack.instance, 2, world, (int) player.posX, (int) player.posY, (int) player.posZ);
//			}
//			player.openGui(AdventureBackpack.instance, 2, world, (int) player.posX, (int) player.posY, (int) player.posZ);
...
//		}
	...
	public void onArmorTickUpdate(World world, EntityPlayer player,ItemStack stack) {
		...
		if(stack.stackTagCompound != null && stack.stackTagCompound.hasKey("colorName")){
			BackpackAbilities.instance.executeAbility(stack.stackTagCompound.getString("colorName"), player, world, stack);
		}
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack stack, int armorSlot) {
		...
		return ModelAdvBackpackArmor.instance
				.setTanks(inv.getLeftTank().getFluid(), inv.getRightTank().getFluid())
