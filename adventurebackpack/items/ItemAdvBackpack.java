...
public class ItemAdvBackpack extends ItemArmor {
	...
	public boolean placeBackpack(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
			boolean from) {
	...
	public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack stack) {
		...
		if (stack.stackTagCompound != null && stack.stackTagCompound.hasKey("colorName")) {
			BackpackAbilities.instance.executeAbility(stack.stackTagCompound.getString("colorName"), player, world,
					stack);
		}
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack stack, int armorSlot) {
		...
		return ModelAdvBackpackArmor.instance.setTanks(inv.getLeftTank().getFluid(), inv.getRightTank().getFluid())
