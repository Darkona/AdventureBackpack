...
public class Hose extends ItemBucket implements IFluidContainerItem {
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
		...
		if (mode == 0)
		{
			...
			FluidTank tank = (name == "leftTank") ? inventory.getLeftTank() : (name == "rightTank") ? inventory.getRightTank() : null;
	...
	public FluidStack getFluid(ItemStack container) {
		...
		{
			FluidStack fluid = new FluidStack(FluidRegistry.getFluid(container.stackTagCompound.getString("FluidName")),
