...
public class FluidEffect {
	...
	/**
	 * This method determines what will happen to the player when drinking the corresponding fluid.
	 * For example set potion effects, set player on fire, heal, fill hunger, etc.
	 * You can use the world parameter to make conditions based on where the player is.
