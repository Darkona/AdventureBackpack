...
public class RendererSleepingBag extends TileEntitySpecialRenderer{
	...
	private final ResourceLocation modelTexture = new ResourceLocation("adventurebackpack","textures/sleepingbag.png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		...
		GL11.glPushMatrix();
		if(dir == 0)GL11.glRotatef(0F, 0.0F, 1.0F, 0.0F);
		if(dir%2!=0)GL11.glRotatef(dir*(90F), 0.0F, 1.0F, 0.0F);
		if(dir==2)GL11.glRotatef(-180F, 0.0F, 1.0F, 0.0F);
