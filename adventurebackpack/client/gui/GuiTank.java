...
public class GuiTank {
	 ...
	 * @param resolution The resolution of the fluid painted in the tank. Higher values mean smaller and more numerous boxes.
	 * Values can be 1, 2, 4, 8, 16. Other values are untested, but i guess they should always be integer divisors of the width, 
	 * with modulus 0;
	 */
	...
	private void drawMethodThree(openGui gui, FluidStack theFluid) {
		if(theFluid != null){
			...
			if(name.lastIndexOf(":")>-1){
				String fixedName = name.substring(0,name.lastIndexOf(":")) + 
						":textures/blocks/" + 
	 ...
	 * @param srcX The X coordinate from the icon to start drawing from. Starts at 0.
	 * @param srcY The Y coordinate from the icon to start drawing from. Starts at 0.
