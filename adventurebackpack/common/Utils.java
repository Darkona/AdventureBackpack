...
public class Utils {
	...
	public static ResourceLocation getBackpackColor(ItemStack item) {
		...
		color = new ResourceLocation("adventurebackpack", "textures/backpack/backpack"
	...
	public static Block blockies[] = { Block.melon, Block.cactus, Block.glowStone, Block.blockRedstone, Block.snow,
			Block.sponge, Block.obsidian, Block.sandStone, Block.chest, Block.coalBlock, Block.hay, Block.pumpkin,
			Block.blockNetherQuartz, Block.blockEmerald, Block.blockDiamond, Block.blockIron, Block.blockSnow,
			Block.bookShelf, Block.blockGold, Block.cloth, Block.dragonEgg, Block.enchantmentTable, Block.mushroomRed,
			Block.mushroomBrown, Block.blockLapis };

	public static Item[] items = {

	Item.blazeRod, Item.eyeOfEnder, Item.feather, Item.spiderEye, Item.slimeBall, Item.egg, Item.cake, Item.leather,
			Item.skull, Item.beefRaw, Item.porkRaw, Item.cookie, Item.enderPearl, Item.magmaCream, Item.netherStar,
			Item.bone, Item.fishRaw, Item.ghastTear, Item.bowlSoup, Item.netherStalkSeeds };
