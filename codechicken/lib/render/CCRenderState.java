...
public class CCRenderState {
	...
	public static void setBrightness(IBlockAccess world, int x, int y, int z) {
		...
		setBrightness(block == null ? world.getLightBrightnessForSkyBlocks(x, y, z, 0) : block
	...
	public static void apply() {
		...
		if (hasColour)
			Tessellator.instance.setColorRGBA(colour >> 24 & 0xFF, colour >> 16 & 0xFF, colour >> 8 & 0xFF,
					colour & 0xFF);
	}
