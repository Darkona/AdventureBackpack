...
public class CCRenderState
{
	...
	public static void setBrightness(IBlockAccess world, int x, int y, int z)
	{
		...
		setBrightness(block == null ? world.getLightBrightnessForSkyBlocks(x,
			y, z, 0) : block.getMixedBrightnessForBlock(world, x, y, z));
	...
	public static void setColour(int c)
	{
		hasColour = true;
		colour = c;
		Tessellator.instance.setColorRGBA(colour >> 24 & 0xFF,
	...
	{
		setBrightness((int) OpenGlHelper.lastBrightnessY << 16
			| (int) OpenGlHelper.lastBrightnessX);
	}
